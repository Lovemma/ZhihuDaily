...
public class ThemesContent {
    ...
    private List<ThemesStoryItem> stories;
    ...
    public List<ThemesStoryItem> getStories() {
        return stories;
    }

    public void setStories(List<ThemesStoryItem> stories) {
    ...
    public static class ThemesStoryItem {
    }
